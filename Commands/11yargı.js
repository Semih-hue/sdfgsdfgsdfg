...
module.exports.execute = async (client, message, args) => {
    ...
    let embed = new MessageEmbed().setAuthor(executor.user.tag, executor.user.displayAvatarURL({dynamic: true})).setFooter('Adalet gruba katıldı!').setColor("RED").setTimestamp();
